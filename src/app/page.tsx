...
import {Card, Flex, Layout, Tag} from "antd";
import Sider from "antd/es/layout/Sider";
import {CalendarOutlined, FolderOutlined, TagOutlined} from "@ant-design/icons";
...
export default function Home() {
  ...
  return (
    <Layout style={{backgroundColor: 'var(----foreground)'}}>
